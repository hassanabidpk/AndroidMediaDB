...
public class ImageCache {
    ...
    private LruCache<String, CacheEntry> mMemoryCache;
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            ...
            mMemoryCache = new LruCache<String, CacheEntry>(mCacheParams.memCacheSize) {
                /**
                ...
                @Override
                protected int sizeOf(String key, CacheEntry e) {

                    return getBitmapSize(e.mBitmap);
                }
            };
            Log.d(TAG, "Memory cache created (mMemoryCache = " + mMemoryCache + ")");
        }
    ...
    public void addBitmapToCache(String data, Bitmap bitmap) {
        ...
        if (mMemoryCache != null && mMemoryCache.get(data) == null) {
            mMemoryCache.put(data, new CacheEntry(bitmap));
        }
...
//                            out.write(supported?1:0);
     ...
     */
    public CacheEntry getBitmapFromMemCache(String data) {
        if (mMemoryCache != null) {
            final CacheEntry entry = mMemoryCache.get(data);
            if (entry != null) {
     ...
     * @return The bitmap if found in cache, null otherwise
     */
    public CacheEntry getBitmapFromDiskCache(String data) {
        final String key = hashKeyForDisk(data);
        synchronized (mDiskCacheLock) {
    ...
    public static class ImageCacheParams {
        ...
        public void setMemCacheSizePercent(Context context, float percent) {
            ...
            Log.d(TAG,"setMemCacheSizePercent : " + memCacheSize);
